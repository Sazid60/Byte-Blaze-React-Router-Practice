            ...
            <article className="space-y-8 ">
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col items-start justify-between w-full md:flex-row md:items-center text-gray-400">
                        ...
                        <p className="flex-shrink-0 mt-3 text-sm md:mt-0">{comments_count} • {' '} {public_reactions_count} views</p>
                    </div>
                    <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap  text-black">
                        ...
                        className={`flex cursor-pointer items-center flex-shrink-0 px-5 py-3 space-x-2 ${
                            tabIndex === 0 ? 'border-black border border-b-0' : 'border-b border-black'
                          }  `}>
                        ...
                        className={`flex cursor-pointer items-center flex-shrink-0 px-5 py-3 space-x-2 ${
                            tabIndex === 1 ? 'border-black border  border-b-0' : 'border-b border-black'
                          }  `}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
